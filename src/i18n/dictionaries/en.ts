...
export const en: typeof ja = {
  ...
  pages: {
    todos: {
      title: "Study plan",
      desc: "Set up daily and weekly study tasks and track your progress.",
    },
    notes: {
      title: "Daily notes",
      desc: "Record the expressions and insights you come across each day.",
    },
    practice: {
      title: "Practice",
  ...
  routine: {
    ...
    notes: {
      title: "Note today's insights",
      desc: "Write down new expressions and the things you wished you could say.",
      time: "~5 min",
    },
    themes: [
      "Recent worries",
  ...
  todos: {
    todayHeading: "Today's tasks",
    progressDone: "{done}/{total} done",
    noTasksToday: "No tasks today. Add one on the right.",
    incomplete: "Incomplete",
    complete: "Done",
    management: "Manage tasks",
    ...
    makePlan: "Make a study plan →",
    progress: "Progress",
    allDone: "🎉 All of today's tasks are done!",
  },
  entryMeta: {
  ...
  shadowing: {
    ...
    again: "Start over",
    memoTitle: "Practice notes",
    memoPlaceholder: "Expressions and pronunciation points you noticed…",
    memoAppend: "Append to today's note",
    memoAppended: "Appended to today's note",
    memoHeading: "Repeat practice: {title}",
    memoReminder: "Append your notes to today's note",
  },
  notes: {
    today: "Today",
    unsaved: "Unsaved",
    ...
    loading: "Loading...",
    empty: "No content.",
    editorPlaceholder: "## Today's expressions\n\n- binge-watch - 长时间连续看（剧集等）\n  - I binge-watched the whole season last night.\n\n## Notes\n...",
    tags: "Tags",
    tagPlaceholder: "Type a tag and press Enter",
    addTag: "Add",
    save: "Save",
    saving: "Saving...",
    extract: "Extract entries with AI",
    extracting: "Extracting...",
    listHeading: "Notes",
    noNotes: "No notes yet.",
    emptyNote: "Empty",
    modalTitle: "Extracted entries ({n} selected)",
    noCandidates: "No extractable expressions were found.",
    jp: "English",
    reading: "Reading",
    meaning: "Meaning",
    ...
    importedAlert: "Added {count} entries to your library.",
    prevDay: "Previous day",
    nextDay: "Next day",
    extractTooltip: "Extract expressions from this note with AI and add them as entries",
  },
